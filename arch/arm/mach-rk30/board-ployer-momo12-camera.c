...
static struct rkcamera_platform_data new_camera[] = {      
    new_camera_device_ex(RK29_CAM_SENSOR_GT2005, //momo12
                        back,
                        0,//INVALID_VALUE,
                        INVALID_VALUE,
                        INVALID_VALUE,
                        ...
                        INVALID_VALUE,
                        RK30_PIN1_PD6,
                        CONS(RK29_CAM_SENSOR_GT2005,_PWRDN_ACTIVE),
                        0,
                        CONS(RK29_CAM_SENSOR_GT2005,_FULL_RESOLUTION),
                        0x00,
                        3,
                        100000,
                        CONS(RK29_CAM_SENSOR_GT2005,_I2C_ADDR),
                        0,
                        24),
    new_camera_device_ex(RK29_CAM_SENSOR_GC2035, //perfeo
                        back,
                        0,//INVALID_VALUE,
                        INVALID_VALUE,
                        INVALID_VALUE,
